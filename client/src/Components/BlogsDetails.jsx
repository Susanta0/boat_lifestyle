...
const popularBlogsData = [
  {
    id: 1,
    image:
      "https://www.boat-lifestyle.com/cdn/shop/articles/Gaming_Earbuds_for_Travel-_Compact_and_Portable_Gaming_Solutions_600x.png?v=1711005465",
    date: "21 Mar, 2024",
  ...
  },
  {
    id: 2,
    image:
      "https://www.boat-lifestyle.com/cdn/shop/articles/BLOG4_600x.png?v=1709795916",
    date: "21 Mar, 2024",
    title: "Gaming Earbuds for Travel: Compact and Portable Gaming Solutions",
    description:
      "When nothing can stop a gamer from entering the arena, we have got gaming earbuds so they can enter the arena while they travell.",
  ...
  },
  {
    id: 3,
    image:
      "https://www.boat-lifestyle.com/cdn/shop/articles/ANC_for_Work-_How_Noise-Canceling_Headphones_Can_Boost_Productivity_600x.png?v=1709883646",
    date: "21 Mar, 2024",
    title: "Gaming Earbuds for Travel: Compact and Portable Gaming Solutions",
    description:
      "When nothing can stop a gamer from entering the arena, we have got gaming earbuds so they can enter the arena while they travell.",
  ...
  },
  {
    id: 4,
    image:
      "https://www.boat-lifestyle.com/cdn/shop/articles/Blog_Dolby_600x.png?v=1736235911",
    date: "21 Mar, 2024",
    title: "Gaming Earbuds for Travel: Compact and Portable Gaming Solutions",
    description:
      "When nothing can stop a gamer from entering the arena, we have got gaming earbuds so they can enter the arena while they travell.",
    ...
    <>
      <div className="introvideo mt-5 flex justify-between gap-x-2 overflow-x-scroll w-[95%] m-auto">
        {popularBlogsData.map((ele, ind) => (
          <div
            key={ind}
            className="min-w-[355.3px] min-h-[377.45px] border rounded-lg bg-[#FAFAFA]"
          >
            <img
              src={ele.image}
              alt={ele.title}
            ...
            <div className="px-4 bg-[#FAFAFA] flex flex-col justify-center gap-y-1.5">
              <span className="text-[#8D8E91] text-[15px] mt-1.5">
                {ele.date}
              </span>
              <h2 className="font-extrabold text-[18px] ">{ele.title}</h2>
              <p className="text-[#6F8397] text-[14px]">
