...
const sliderData=[
    {
        id:1,
        images:"https://www.boat-lifestyle.com/cdn/shop/files/Business_World_231x.png?v=1705038093",
     ...
     <ProductsNameViewAll
          ...
          <div className="relative overflow-hidden w-full h-[300px] border-2">
            {sliderData.map((ele, index)=> (
                <div key={ele.id}  className={`absolute top-0 left-0 w-[100%] h-full object-cover transition-all duration-500 flex justify-center ${
                    ...
                    <div className='border-2 px-40 w-[60%] h-full flex flex-col items-center bg-[#F7F9FA]'>
                      <img src="../../public/coma.png" alt="" className='w-[36px] h-[33px] border' />
                        <p className='m-auto text-[#666666] text-[22px] text-center border'>{ele.text}</p>
                    </div>
                </div>
            ))}
